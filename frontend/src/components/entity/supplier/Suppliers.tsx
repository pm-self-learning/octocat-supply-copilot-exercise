              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <a href={`mailto:${supplier.email}`} className="text-light hover:text-primary transition-colors">
                      {supplier.email}
                    </a>
                  </div>
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <a href={`tel:${supplier.phone}`} className="text-light hover:text-primary transition-colors">
                      {supplier.phone}
                    </a>
                  </div>
                </div>
